...
set rtl_dir [file join $repo_root build hls graphsage_int8_po2_locality solution1 syn verilog]
set xdc_file [file join $script_dir graphsage_int8_po2_ooc.xdc]
set output_dir [file join $repo_root build vivado_sweep locality_build]
set output_checkpoint [file join $repo_root build vivado_sweep locality_post_synth.dcp]
...
if {[llength $rtl_files] == 0} {
    error "No locality HLS RTL found in $rtl_dir"
}
...
puts "LOCALITY_RTL_DIR=$rtl_dir"
puts "LOCALITY_RTL_FILES=[llength $rtl_files]"
puts "LOCALITY_OUTPUT_CHECKPOINT=$output_checkpoint"
...
puts "LOCALITY_CHECKPOINT_COMPLETE=1"
exit 0