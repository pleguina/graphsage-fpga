...
set project_dir [file join $repo_root build hls graphsage_int8_po2_ii2_reuse]
set source_file [file join $script_dir graphsage_layer_int8_po2_ii2_reuse.cpp]
set header_file [file join $script_dir graphsage_layer_int8_po2_ii2_reuse.h]
...
puts "HLS_II2_REUSE_SYNTHESIS_COMPLETE=1"
close_project
exit 0