...
set rtl_dir [file join $package_root build hls cora_root_dynamic_const_weights_2024_1 solution1 syn verilog]
set xdc_file [file join $script_dir graphsage_int8_po2_ooc.xdc]
set output_dir [file join $repo_root build vivado_sweep updated_root_low_dsp_build]
set output_checkpoint [file join $repo_root build vivado_sweep updated_root_low_dsp_post_synth.dcp]

set top_function graphsage_root_dynamic_const_weights
set part_name xcvu13p-fsga2577-1-e
set clock_period 2.77
set rtl_files [glob -nocomplain [file join $rtl_dir *.v]]

if {[llength $rtl_files] == 0} {
    error "No updated root HLS RTL found in $rtl_dir"
}
...
puts "UPDATED_ROOT_LOW_DSP_RTL_DIR=$rtl_dir"
puts "UPDATED_ROOT_LOW_DSP_RTL_FILES=[llength $rtl_files]"
puts "UPDATED_ROOT_LOW_DSP_OUTPUT_CHECKPOINT=$output_checkpoint"
...
puts "UPDATED_ROOT_LOW_DSP_CHECKPOINT_COMPLETE=1"
exit 0