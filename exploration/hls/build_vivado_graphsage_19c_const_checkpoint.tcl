...
set rtl_dir [file join $repo_root build hls graphsage_int8_po2_19c_const_params solution1 syn verilog]
set xdc_file [file join $script_dir graphsage_int8_po2_ooc.xdc]
set build_name [expr {
    [info exists ::env(CONST_BUILD_NAME)]
        ? $::env(CONST_BUILD_NAME)
        : "graphsage_19c_const_build"
}]
set checkpoint_name [expr {
    [info exists ::env(CONST_CHECKPOINT_NAME)]
        ? $::env(CONST_CHECKPOINT_NAME)
        : "graphsage_19c_const_post_synth.dcp"
}]
set output_dir [file join $repo_root build vivado_sweep $build_name]
set output_checkpoint [file join $repo_root build vivado_sweep $checkpoint_name]
...
if {[llength $rtl_files] == 0} {
    error "No constant-parameter HLS RTL found in $rtl_dir"
}
...
puts "GRAPHSAGE_19C_CONST_RTL_DIR=$rtl_dir"
puts "GRAPHSAGE_19C_CONST_RTL_FILES=[llength $rtl_files]"
puts "GRAPHSAGE_19C_CONST_OUTPUT_CHECKPOINT=$output_checkpoint"
...
puts "GRAPHSAGE_19C_CONST_CHECKPOINT_COMPLETE=1"
exit 0