...
def train_float(dataset, data, epochs, learning_rate, output_path):
...
def train_qat(dataset, data, float_model, epochs, learning_rate, calibration_passes, output_path):
...
def run_dataset(name, args):
    ...
    float_model, float_metrics, best_epoch = train_float(
        dataset, data, args.float_epochs, args.float_lr, float_path
    )
