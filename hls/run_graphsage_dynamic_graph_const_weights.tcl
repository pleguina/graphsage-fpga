...
set project_dir [file join $repo_root build hls graphsage_dynamic_graph_const_weights]
set source_file [file join $script_dir graphsage_layer_int8_po2_dynamic_graph_const_weights.cpp]
set testbench_file [file join $script_dir testbench_graphsage_dynamic_graph_const_weights.cpp]
set top_function graphsage_dynamic_graph_const_weights
...
puts "HLS_DYNAMIC_GRAPH_FLOW_COMPLETE=1"
close_project
exit 0